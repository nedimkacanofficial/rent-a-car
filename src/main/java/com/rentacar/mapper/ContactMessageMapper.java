...
public class ContactMessageMapper {
    ...
    public static List<ContactMessage> toEntityList(List<ContactMessageRequestDTO> requestDTOs) {
        return requestDTOs.stream().map(ContactMessageMapper::toEntity).collect(Collectors.toList());
    }
}
